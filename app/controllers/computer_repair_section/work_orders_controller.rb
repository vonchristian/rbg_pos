module ComputerRepairSection 
  class WorkOrdersController < ApplicationController
    ...
    def work_order_params
      params.require(:work_order).permit(:section_id, :under_warranty, :supplier_id, :purchase_date, :expiry_date, :service_number, :status, :customer_id, :reported_problem, :physical_condition, product_unit_attributes: [:description, :model_number, :serial_number])
    end 
  end 
end 