module Reports
  class SalesPdf < Prawn::Document
    ...
    def orders_data
      [["DATE", "CUSTOMER", "ITEMS", "MODE OF PAYMENT", "DISCOUNT", "TOTAL COST", "TOTAL COST LESS DISCOUNT", "REF #"]] +
      @orders_data ||= @orders.map{|o| [o.date.strftime("%B %e, %Y"), o.customer.try(:full_name).try(:upcase), order_description(o), o.mode_of_payment, price(o.discount_amount), price(o.total_cost), price(o.total_cost_less_discount), o.reference_number] } +
