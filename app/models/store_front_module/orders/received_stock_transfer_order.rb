module StoreFrontModule
  module Orders
    class ReceivedStockTransferOrder < Order
      ...
      has_many :received_stock_transfer_order_line_items,
               class_name: "StoreFrontModule::LineItems::ReceivedStockTransferOrderLineItem", foreign_key: 'order_id'
      delegate :name, to: :origin_store_front, prefix: true
      def total_cost
        received_stock_transfer_order_line_items.sum(&:total_cost)
      end
