class StoreFront < ApplicationRecord
  belongs_to :business
  belongs_to :service_receivable_account_category, class_name: 'AccountingModule::AccountCategory'
  belongs_to :sales_revenue_account_category,      class_name: 'AccountingModule::AccountCategory'
