class Stock < ApplicationRecord
  ...
  def create_entry_for_stock
    ...
    if cash_purchase? 
      ...
      AccountingModule::Entry.create!(entry_type: 'credit_stock', commercial_document: self, entry_date: self.date, description: "Credit/Transferred/Old  of stocks", debit_amounts_attributes: [amount: self.total_cost, account: merchandise_inventory], credit_amounts_attributes:[amount: self.total_cost, account: accounts_payable])
    end
  end
end
